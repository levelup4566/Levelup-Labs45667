...
async function IntensiveProgressCheck(clerkUserId){
...
async function IntensiveProgressInsert(clerkUserId , learningGoal , currentCourse , currentModule , totalModulesInCourse ,isCompleted , moduleId){
    const {data , error} = await supabase.from("intensive_user_progress")
                                         .insert([
                                            {
