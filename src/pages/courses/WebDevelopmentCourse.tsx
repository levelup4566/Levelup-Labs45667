...
const WebDevelopmentCourse = () => {
  ...
  const modules = [
    { id: 1, title: 'HTML Fundamentals', duration: '2 hours', completed: false },
    { id: 2, title: 'CSS Styling', duration: '3 hours', completed: false },
    { id: 3, title: 'JavaScript Basics', duration: '4 hours', completed: false },
    { id: 4, title: 'React Introduction', duration: '5 hours', completed: false },
    { id: 5, title: 'Building Projects', duration: '6 hours', completed: false },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white mb-8">
          <div className="container px-4 py-6 max-w-6xl">
            ...
            <h1 className="text-4xl font-bold mb-2">Web Development Fundamentals</h1>
            <p className="text-lg text-white/90 mb-4">Master the essentials of modern web development</p>
