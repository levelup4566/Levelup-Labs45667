...
const DataScienceCourse = () => {
  ...
  const modules = [
    ...
    { id: 2, title: 'Data Analysis with Pandas', duration: '4 hours', completed: false },
    { id: 3, title: 'Data Visualization', duration: '3 hours', completed: false },
    { id: 4, title: 'Machine Learning Basics', duration: '5 hours', completed: false },
    { id: 5, title: 'Real-world Projects', duration: '6 hours', completed: false },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white mb-8">
          <div className="container px-4 py-6 max-w-6xl">
            ...
            <h1 className="text-4xl font-bold mb-2">Data Science Fundamentals</h1>
            <p className="text-lg text-white/90 mb-4">Master data analysis, visualization, and machine learning</p>
